...
func (x *Dict) Reset() {
	*x = Dict{}
	if protoimpl.UnsafeEnabled {
		mi := &file_utils_dict_dict_proto_msgTypes[0]
...
func (*Dict) Descriptor() ([]byte, []int) {
	return file_utils_dict_dict_proto_rawDescGZIP(), []int{0}
}
...
var File_utils_dict_dict_proto protoreflect.FileDescriptor

var file_utils_dict_dict_proto_rawDesc = []byte{
	0x0a, 0x15, 0x75, 0x74, 0x69, 0x6c, 0x73, 0x2f, 0x64, 0x69, 0x63, 0x74, 0x2f, 0x64, 0x69, 0x63,
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x64, 0x69, 0x63, 0x74, 0x1a, 0x0e, 0x70,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x47, 0x0a, 0x17, 0x78, 0x79, 0x7a, 0x2e, 0x68, 0x6f,
	0x70, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x64, 0x69, 0x63,
	0x74, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x69,
	0x6f, 0x76, 0x2f, 0x68, 0x6f, 0x70, 0x65, 0x72, 0x2f, 0x76, 0x32, 0x2f, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x2f, 0x75, 0x74, 0x69, 0x6c, 0x73, 0x2f, 0x64, 0x69, 0x63, 0x74, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_utils_dict_dict_proto_rawDescOnce sync.Once
	file_utils_dict_dict_proto_rawDescData = file_utils_dict_dict_proto_rawDesc
)

func file_utils_dict_dict_proto_rawDescGZIP() []byte {
	file_utils_dict_dict_proto_rawDescOnce.Do(func() {
		file_utils_dict_dict_proto_rawDescData = protoimpl.X.CompressGZIP(file_utils_dict_dict_proto_rawDescData)
	})
	return file_utils_dict_dict_proto_rawDescData
}

var file_utils_dict_dict_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_utils_dict_dict_proto_goTypes = []interface{}{
	(*Dict)(nil), // 0: dict.Dict
}
var file_utils_dict_dict_proto_depIdxs = []int32{
...
func init() { file_utils_dict_dict_proto_init() }
func file_utils_dict_dict_proto_init() {
	if File_utils_dict_dict_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_utils_dict_dict_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Dict); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_utils_dict_dict_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_utils_dict_dict_proto_goTypes,
		DependencyIndexes: file_utils_dict_dict_proto_depIdxs,
		MessageInfos:      file_utils_dict_dict_proto_msgTypes,
	}.Build()
	File_utils_dict_dict_proto = out.File
	file_utils_dict_dict_proto_rawDesc = nil
	file_utils_dict_dict_proto_goTypes = nil
	file_utils_dict_dict_proto_depIdxs = nil
}

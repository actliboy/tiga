...
func (c *noteServiceClient) Create(ctx context.Context, in *Note, opts ...grpc.CallOption) (*response.CommonRep, error) {
	out := new(response.CommonRep)
	err := c.cc.Invoke(ctx, "/content.NoteService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNoteServiceServer) Create(context.Context, *Note) (*response.CommonRep, error) {
...
func _NoteService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/content.NoteService/Create",
	}
